  ...
  container.innerHTML = `
    ...
    <div class="kpi-card" style="--card-accent: #10b981;">
      <div class="kpi-header">
        ...
        <div class="kpi-icon-wrap" style="color: #10b981;">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        </div>
      </div>
      <div class="kpi-value" style="color: #10b981;">${formatBRL(metrics.wonTotal)}</div>
      <div class="kpi-subtext">
    ...
    <div class="kpi-card" style="--card-accent: #a855f7;">
      <div class="kpi-header">
        ...
        <div class="kpi-icon-wrap" style="color: #a855f7;">
    ...
    <div class="kpi-card" style="--card-accent: #06b6d4;">
      <div class="kpi-header">
        ...
        <div class="kpi-icon-wrap" style="color: #06b6d4;">
      ...
      <div class="pipeline-column" data-stage="${stage.id}" ondragover="event.preventDefault()" ondrop="window.handleDropCard(event, '${stage.id}')">
        <div class="column-header">
          <div class="column-title-wrap">
            <span class="column-indicator" style="background-color: ${stage.color}; box-shadow: 0 0 8px ${stage.color}"></span>
        ...
        <div class="cards-container">
          ${stageCustomers.length === 0 ? `
            <div style="padding: 2rem 1rem; text-align: center; color: var(--text-muted); font-size: 0.8rem; border: 1px dashed var(--border-subtle); border-radius: var(--radius-md);">
    ...
    <div class="lead-card" 
      ...
      <div class="card-footer">
        ...
        <div class="card-actions">
          <button class="action-btn" onclick="window.handleAnalyzeWithAI('${customer.id}')" title="Analisar com Google Gemini AI" style="color: #a855f7;">
    ...
    return `
      <tr>
        ...
        <td>
          ...
          <div class="customer-subtext">${escapeHtml(customer.phone || '-')}</div>
        </td>
        <td>
        ...
        <td>
          <span class="stage-badge" style="background: ${stageObj.bg}; color: ${stageObj.color}; border: 1px solid ${stageObj.color}40;">
        ...
        <td style="text-align: right;">
          <button class="btn btn-outline btn-sm" onclick="window.handleAnalyzeWithAI('${customer.id}')" style="margin-right: 0.35rem; color: #a855f7; border-color: rgba(168, 85, 247, 0.4);" title="Análise com Gemini AI">
            ✦ IA
          </button>
    ...
    container.innerHTML = `
      <div class="user-profile-badge">
        ${user.photoURL ? `<img src="${user.photoURL}" class="user-avatar-img" alt="${escapeHtml(user.name)}">` : `
          <div style="width: 22px; height: 22px; border-radius: 50%; background: #6366f1; display:flex; align-items:center; justify-content:center; font-size:10px; color:#fff; font-weight:700;">
...
export function renderConnectionStatus(mode) {
  ...
  if (mode === 'firestore') {
    ...
    pill.innerHTML = `
      <span class="pulse-dot" style="background-color: #f59e0b; box-shadow: 0 0 8px #f59e0b;"></span>
